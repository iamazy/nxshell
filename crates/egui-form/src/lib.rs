...
/// To use [garde] with `egui-form`, you need to create a [`garde::GardeReport`] and pass it to the [Form] instance.
///
...
/// #
/// # use egui-form::{Form, FormField};
/// # use garde::Validate;
/// # use egui-form::garde::field_path;
///
...
///     let mut form = Form::new().add_report(egui-form::garde::GardeReport::new(test.validate()));
///
...
mod form_field;
/// To use [validator] with `egui-form`, you need to create a [`validator::ValidatorReport`] and pass it to the [Form] instance.
///
...
/// # Example
/// ```no_run
/// # // Taken 1:1 from crates/egui-form/examples/validator.rs
/// # use eframe::NativeOptions;
/// # use egui::CentralPanel;
/// # use egui-form::{Form, FormField};
/// # use validator::Validate;
/// # use egui-form::validator::field_path;
///
/// #[derive(Validate, Debug)]
/// struct Test {
...
///         egui-form::validator::ValidatorReport::new(test.validate()).with_translation(|error| {
